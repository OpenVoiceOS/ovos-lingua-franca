...
NUMBERS_FIXTURE_UK = {
    ...
    1.75: "1 и 3 чверті",
    3.4: "3 и 2 п'яті",
    16.8333: "16 и 5 шостих",
    12.5714: "12 и 4 сьомих",
    9.625: "9 и 5 восьмих",
    6.777: "6 и 7 дев'ятих",
    3.1: "3 и 1 десята",
    2.272: "2 и 3 одинадцяті",
    5.583: "5 и 7 дванадцяті",
    8.384: "8 и 5 тринадцяті",
    0.071: "1 чотирнадцяті",
    6.466: "6 и 7 п'ятнадцяті",
    8.312: "8 и 5 шостнадцяті",
    2.176: "2 и 3 сімнадцяті",
    200.722: "200 и 13 вісімнадцяті",
    7.421: "7 и 8 дев'ятнадцяті",
    0.05: "1 двадцята"
}
...
class TestPronounceNumber(unittest.TestCase):
    ...
    def test_convert_decimals(self):
        ...
        self.assertEqual(pronounce_number(-0.05), "мінус нуль крапка нyль п'ять")
    ...
    def test_convert_stos(self):
        ...
        self.assertEqual(pronounce_number(666), "шість сотень шістдесят шість")
        ...
        self.assertEqual(pronounce_number(103254654), "сто три мільйона "
                                                      ...
                                                      "шість сотень "
                                                      "п'ятдесят чотири")
        self.assertEqual(pronounce_number(1512457), "мільйон п'ятьсот"
                                                    " дванадцять тисяч "
                                                    "чотириста п'ятдесят "
                                                    "сім")
    ...
    def test_large_numbers(self):
        ...
        self.assertEqual(
            ...
            "сто квінтільйонів тридцять чотири квадрильйона "
            "двісті дев'яносто дев'ять мільйонів сімсот "
            "дев'яносто дві тисячі чотириста п'ятдесят вісім")
        self.assertEqual(
        ...
        self.assertEqual(pronounce_number(95505896639631893, short_scale=True),
                         "дев'яносто п'ять квадрільйонів "
                         "п'ятьсот п'ять трильйонів"
                         "вісімсот дев'яносто шість мільярдів "
                         "шість сотень тридцять дев'ять мільйонів "
                         "шість сотень тридцять одна тисяча "
                         "вісімсот дев'яносто три")
        self.assertEqual(pronounce_number(95505896639631893,
                                          short_scale=False),
                         "дев'яносто п'ять тысяч п'ятьсот п'ять мільярдів "
                         "вісімсот дев'яносто шість тысяч "
                         "шість сотень тридцять дев'ять мільйонів "
                         "шість сотень тридцять одна тисяча "
                         "вісімсот дев'яносто три")
        ...
        self.assertEqual(pronounce_number(1.9874522571e80, places=9),
                         ...
                         "п'ятьсот шістьдесят дев'ять октильйонів "
                         "триста сімдесят п'ять септільйонів "
                         "двісті тридцять дев'ять секстильйонів "
                         "шість сотень сімдесят квінтільйонів "
                         "п'ятьсот сімдесят чотири квадрильйона "
    ...
    def test_ordinals(self):
        ...
        self.assertEqual(pronounce_number(18691, ordinals=True),
                         "вісемнадцять тисяч шість сотень дев'яносто перший")
        self.assertEqual(pronounce_number(1567, ordinals=True),
                         "тисяча п'ятьсот шістьдесят сьомий")
        self.assertEqual(pronounce_number(1.672e-27, places=3,
